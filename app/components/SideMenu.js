    ...
    <div className="flex h-screen w-16 flex-col justify-between border-e border-gray-200 bg-white dark:bg-neutral-800 dark:border-neutral-700">
      <div>
        <div className="inline-flex size-16 items-center justify-center">
          <span className="grid size-10 place-content-center rounded-lg bg-gray-100 text-xs text-gray-600 dark:bg-neutral-700 dark:text-neutral-400">
            L
          </span>
        </div>
        ...
        <div className="border-t border-gray-200 dark:border-neutral-700">
          <div className="px-2">
            <div className="py-4">
              <a
                href="#"
                className="t group relative flex justify-center rounded-sm bg-blue-50 px-2 py-1.5 text-blue-700 dark:bg-blue-900/50 dark:text-blue-500"
              >
                <svg
