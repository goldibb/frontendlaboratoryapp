...
export default function Header() {
  ...
  const getLinkClass = (path) => {
    ...
    const baseClass =
      "p-2 flex items-center text-sm rounded-lg focus:outline-hidden focus:bg-gray-100 dark:focus:bg-neutral-700";
    const activeClass =
            ...
            <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
              <div className="grow">
                <div className="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                  ...
                  <Link
                    className={getLinkClass("/user/calendar")}
                    href="/user/calendar"
                    aria-current={
                      pathname === "/user/calendar" ? "page" : undefined
                    }
                  >
                    <svg
                      className="shrink-0 size-4 me-3 md:me-2 block md:hidden"
                  ...
                  <Link
                    ...
                    href="/user/profile"
                    aria-current={
                      pathname === "/user/profile" ? "page" : undefined
                    }
                  >
                    <svg
                      className="shrink-0 size-4 me-3 md:me-2 block md:hidden"
